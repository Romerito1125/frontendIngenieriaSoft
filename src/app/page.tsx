...
export default function Home() {
  const sections = [
    { name: "Rutas", path: "/rutas", icon: "/icons/rutas.png" },
    {
      ...
      icon: "/icons/buses.jpg",
    },
    {
      name: "Saldo y Recargas Tullave",
      path: "/saldo-y-recargas",
      icon: "/icons/saldo.png",
    },
    {
      name: "Planea tu Viaje",
      path: "/planea-tu-viaje",
      icon: "/icons/planea.png",
    },
    { name: "Mapa MIO", path: "/mapa", icon: "/icons/mapa.png" },
    { name: "Noticias", path: "/noticias", icon: "/icons/noticias.png" },
    { name: "Denuncias", path: "/denuncias", icon: "/icons/denuncias.png" },
    {
      name: "Canal WhatsApp Seguridad - Emergencias",
      path: "/canal-de-whatsapp",
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 w-full max-w-3xl place-items-center">
          {sections.map((section, index) => (
            ...
            >
              ...
              <h2 className="mt-4 text-sm md:text-base font-medium text-center">
                {section.name}
              </h2>
            </Link>
          ))}
